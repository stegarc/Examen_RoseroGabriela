                ...
                <div class="row">
                    <div class="col-xl-11 col-lg-7">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form class="" id="forma" name="forma" method="post"
                                    action="./service/moduloNuevoService.php">
                                    <div class="card-body border border-top-0 rounded-bottom-sm p-7">
                                        <input type="hidden" name="nombrerol" value="<?php echo $_POST['orden']; ?>">
                                        <div class="row">
                                            <div class="form-group form-group-icon col-lg-6 ">
                                                <label for="nombre ">ROL</label>
                                                <input type="text" class="form-control border-warning rounded-sm "
                                                    name="nombrerol" value="<?php echo $_POST['orden']; ?>" disabled>
                                            </div>
                                            <div class="form-group form-group-icon col-lg-6 ">
                                            ...
                                            ?>
                                                <select name="nombreMod" class="form-control border-warning rounded-sm"
                                                    id="selector">
                                                    <?php
